...
class cuserlevels_addopt extends cuserlevels {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_idperfil"] = $this->idperfil->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->idperfil->FldIsDetailKey) {
			$this->idperfil->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_idperfil")));
		}
	}
	...
	function RestoreFormValues() {
		...
		$this->idperfil->CurrentValue = ew_ConvertToUtf8($this->idperfil->FormValue);
	}
...
fuserlevelsaddopt.Lists["x_idperfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<input type="text" data-table="userlevels" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelname->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelname->EditValue ?>"<?php echo $userlevels->userlevelname->EditAttributes() ?>>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_idperfil"><?php echo $userlevels->idperfil->FldCaption() ?></label>
		<div class="col-sm-9">
