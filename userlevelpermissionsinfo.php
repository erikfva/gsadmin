...
class cuserlevelpermissions extends cTable {
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "\"registro_derecho\".\"userlevelpermissions\"";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('userlevelpermissions', 'userlevelpermissions', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new cField('userlevelpermissions', 'userlevelpermissions', 'x_permission', 'permission', '"permission"', 'CAST("permission" AS varchar(255))', 3, -1, FALSE, '"permission"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "\"registro_derecho\".\"userlevelpermissions\"";
	}
