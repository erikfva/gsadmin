...
class cuserlevels_list extends cuserlevels {
	...
	function RenderRow() {
		...
		if (strval($this->idperfil->CurrentValue) <> "") {
			$sFilterWrk = "\"idperfil\"" . ew_SearchString("=", $this->idperfil->CurrentValue, EW_DATATYPE_NUMBER, "");
...
fuserlevelslist.Lists["x_idperfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($userlevels->idperfil->Visible) { // idperfil ?>
	<?php if ($userlevels->SortUrl($userlevels->idperfil) == "") { ?>
		<th data-name="idperfil"><div id="elh_userlevels_idperfil" class="userlevels_idperfil"><div class="ewTableHeaderCaption"><?php echo $userlevels->idperfil->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="idperfil"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->idperfil) ?>',1);"><div id="elh_userlevels_idperfil" class="userlevels_idperfil">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $userlevels->idperfil->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($userlevels->idperfil->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($userlevels->idperfil->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php if ((!ew_EmptyStr($userlevels->userlevelname->ListViewValue())) && $userlevels->userlevelname->LinkAttributes() <> "") { ?>
<a<?php echo $userlevels->userlevelname->LinkAttributes() ?>><?php echo $userlevels->userlevelname->ListViewValue() ?></a>
<?php } else { ?>
<?php echo $userlevels->userlevelname->ListViewValue() ?>
<?php } ?>
</span>
</span>
<a id="<?php echo $userlevels_list->PageObjName . "_row_" . $userlevels_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($userlevels->idperfil->Visible) { // idperfil ?>
		<td data-name="idperfil"<?php echo $userlevels->idperfil->CellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_idperfil" class="userlevels_idperfil">
<span<?php echo $userlevels->idperfil->ViewAttributes() ?>>
<?php echo $userlevels->idperfil->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
