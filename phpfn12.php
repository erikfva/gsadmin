...
function &DbHelper($dbid = "") {
	if ($dbid == "lime_hc" || $dbid === 1) // lime_hc
		$dbclass = "clime_hc_db";
	else // DB
		$dbclass = "cgeodatabase_db";
...
function CurrentProjectID() {
	...
	return "{00441056-EF9D-4233-BDD9-EE81681FA399}";
}
...
class cBreadcrumb {
	...
	function __construct() {
		global $Language;
		$this->Links[] = array("home", "HomePage", "main.php", "ewHome", "", FALSE); // Home
	}
...
class cAdvancedSecurity {
	...
	function TablePermission_Loaded() {
		...
		//dando permiso a todos los usuarios para acceder a la página main.php
