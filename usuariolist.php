...
class cusuario_list extends cusuario {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->autologinip->AdvancedSearch->ToJSON(), ","); // Field autologinip
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field autologinip
		$this->autologinip->AdvancedSearch->SearchValue = @$filter["x_autologinip"];
		$this->autologinip->AdvancedSearch->SearchOperator = @$filter["z_autologinip"];
		$this->autologinip->AdvancedSearch->SearchCondition = @$filter["v_autologinip"];
		$this->autologinip->AdvancedSearch->SearchValue2 = @$filter["y_autologinip"];
		$this->autologinip->AdvancedSearch->SearchOperator2 = @$filter["w_autologinip"];
		$this->autologinip->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->autologinip, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->autologinip); // autologinip
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fusuariolist,url:'" . $this->MultiDeleteUrl . "',msg:ewLanguage.Phrase('DeleteConfirmMsg')});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
fusuariolist.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariolist.Lists["x_activo"].Options = <?php echo json_encode($usuario->activo->Options()) ?>;
fusuariolist.Lists["x_idperfil[]"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $SearchPanelClass = ($usuario_list->SearchWhere <> "") ? " in" : ""; ?>
...
<?php if ($usuario->user->Visible) { // user ?>
	<?php if ($usuario->SortUrl($usuario->user) == "") { ?>
		<th data-name="user"><div id="elh_usuario_user" class="usuario_user"><div class="ewTableHeaderCaption"><?php echo $usuario->user->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->user) ?>',1);"><div id="elh_usuario_user" class="usuario_user">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->user->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuario->user->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->user->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuario->password->Visible) { // password ?>
	<?php if ($usuario->SortUrl($usuario->password) == "") { ?>
		<th data-name="password"><div id="elh_usuario_password" class="usuario_password"><div class="ewTableHeaderCaption"><?php echo $usuario->password->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->password) ?>',1);"><div id="elh_usuario_password" class="usuario_password">
...
<?php if ($usuario->idperfil->Visible) { // idperfil ?>
	<?php if ($usuario->SortUrl($usuario->idperfil) == "") { ?>
		<th data-name="idperfil"><div id="elh_usuario_idperfil" class="usuario_idperfil"><div class="ewTableHeaderCaption"><?php echo $usuario->idperfil->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="idperfil"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->idperfil) ?>',1);"><div id="elh_usuario_idperfil" class="usuario_idperfil">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->idperfil->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuario->idperfil->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->idperfil->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuario->autologinip->Visible) { // autologinip ?>
	<?php if ($usuario->SortUrl($usuario->autologinip) == "") { ?>
		<th data-name="autologinip"><div id="elh_usuario_autologinip" class="usuario_autologinip"><div class="ewTableHeaderCaption"><?php echo $usuario->autologinip->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="autologinip"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->autologinip) ?>',1);"><div id="elh_usuario_autologinip" class="usuario_autologinip">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->autologinip->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuario->autologinip->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->autologinip->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_idusuario" class="usuario_idusuario">
...
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_activo" class="usuario_activo">
...
<?php echo $usuario->activo->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuario->idperfil->Visible) { // idperfil ?>
		<td data-name="idperfil"<?php echo $usuario->idperfil->CellAttributes() ?>>
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_idperfil" class="usuario_idperfil">
...
<?php echo $usuario->idperfil->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuario->autologinip->Visible) { // autologinip ?>
		<td data-name="autologinip"<?php echo $usuario->autologinip->CellAttributes() ?>>
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_autologinip" class="usuario_autologinip">
