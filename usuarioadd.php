...
class cusuario_add extends cusuario {
	...
	function LoadDefaultValues() {
		...
		$this->idperfil->CurrentValue = "general";
		$this->autologinip->CurrentValue = NULL;
		$this->autologinip->OldValue = $this->autologinip->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// idperfil
		$this->idperfil->SetDbValueDef($rsnew, $this->idperfil->CurrentValue, 0, FALSE);

		// autologinip
		$this->autologinip->SetDbValueDef($rsnew, $this->autologinip->CurrentValue, NULL, FALSE);
...
fusuarioadd.Lists["x_idperfil[]"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<input type="password" data-password-strength="pst_x_password" data-password-generated="pgt_x_password" data-table="usuario" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($usuario->password->getPlaceHolder()) ?>"<?php echo $usuario->password->EditAttributes() ?>>
