...
fshapefilesdelete.Lists["x_idusuario"] = {"LinkField":"x_idusuario","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($shapefiles->tipogeom->Visible) { // tipogeom ?>
		<th><span id="elh_shapefiles_tipogeom" class="shapefiles_tipogeom"><?php echo $shapefiles->tipogeom->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($shapefiles->tipogeom->Visible) { // tipogeom ?>
		<td<?php echo $shapefiles->tipogeom->CellAttributes() ?>>
<span id="el<?php echo $shapefiles_delete->RowCnt ?>_shapefiles_tipogeom" class="shapefiles_tipogeom">
