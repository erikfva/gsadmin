...
fuserlevelsdelete.Lists["x_perfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($userlevels->perfil->Visible) { // perfil ?>
		<th><span id="elh_userlevels_perfil" class="userlevels_perfil"><?php echo $userlevels->perfil->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($userlevels->perfil->Visible) { // perfil ?>
		<td<?php echo $userlevels->perfil->CellAttributes() ?>>
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_perfil" class="userlevels_perfil">
