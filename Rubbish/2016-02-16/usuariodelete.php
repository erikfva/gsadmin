...
fusuariodelete.Lists["x_perfil[]"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($usuario->perfil->Visible) { // perfil ?>
		<th><span id="elh_usuario_perfil" class="usuario_perfil"><?php echo $usuario->perfil->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $usuario_delete->RowCnt ?>_usuario_perfil" class="usuario_perfil">
<span<?php echo $usuario->perfil->ViewAttributes() ?>>
<?php echo $usuario->perfil->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
