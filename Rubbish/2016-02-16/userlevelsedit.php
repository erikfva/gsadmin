...
fuserlevelsedit.Lists["x_perfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($userlevels->perfil->Visible) { // perfil ?>
	<div id="r_perfil" class="form-group">
		<label id="elh_userlevels_perfil" for="x_perfil" class="col-sm-2 control-label ewLabel"><?php echo $userlevels->perfil->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $userlevels->perfil->CellAttributes() ?>>
<span id="el_userlevels_perfil">
...
<?php echo $userlevels->perfil->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
