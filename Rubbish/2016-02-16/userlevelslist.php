...
fuserlevelslist.Lists["x_perfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($userlevels->perfil->Visible) { // perfil ?>
	<?php if ($userlevels->SortUrl($userlevels->perfil) == "") { ?>
		<th data-name="perfil"><div id="elh_userlevels_perfil" class="userlevels_perfil"><div class="ewTableHeaderCaption"><?php echo $userlevels->perfil->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="perfil"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->perfil) ?>',1);"><div id="elh_userlevels_perfil" class="userlevels_perfil">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $userlevels->perfil->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($userlevels->perfil->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($userlevels->perfil->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $userlevels_list->PageObjName . "_row_" . $userlevels_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($userlevels->perfil->Visible) { // perfil ?>
		<td data-name="perfil"<?php echo $userlevels->perfil->CellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_perfil" class="userlevels_perfil">
<span<?php echo $userlevels->perfil->ViewAttributes() ?>>
<?php echo $userlevels->perfil->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
