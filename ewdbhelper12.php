...
class cgeodatabase_db extends cDbHelper {

	// Database connection info
	var $Host = 'localhost';
	var $Port = 5432;
	var $Username = 'admderechos';
	var $Password = 'Abt2018*';
	var $DbName = 'geodatabase';
	var $Schema = 'registro_derecho';
...
class clime_hc_db extends cDbHelper {
