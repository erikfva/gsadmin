...
class cshapefiles_list extends cshapefiles {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->acciones->AdvancedSearch->ToJSON(), ","); // Field acciones
		if ($this->BasicSearch->Keyword <> "") {
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->acciones, $arKeywords, $type);
		return $sWhere;
	}
	...
	function LoadSortOrder() {
		...
		if ($sOrderBy == "") {
			if ($this->getSqlOrderBy() <> "") {
				...
				$this->fechacreacion->setSort("DESC");
			}
		}
	}
...
fshapefileslist.Lists["x_idusuario"] = {"LinkField":"x_idusuario","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
