...
fuserlevelsdelete.Lists["x_idperfil"] = {"LinkField":"x_idperfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_idperfil","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($userlevels->idperfil->Visible) { // idperfil ?>
		<th><span id="elh_userlevels_idperfil" class="userlevels_idperfil"><?php echo $userlevels->idperfil->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($userlevels->idperfil->Visible) { // idperfil ?>
		<td<?php echo $userlevels->idperfil->CellAttributes() ?>>
<span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_idperfil" class="userlevels_idperfil">
