...
class cuserlevels extends cTable {
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "\"registro_derecho\".\"userlevels\"";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('userlevels', 'userlevels', 'x_userlevelid', 'userlevelid', '"userlevelid"', 'CAST("userlevelid" AS varchar(255))', 3, -1, FALSE, '"userlevelid"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// idperfil
		$this->idperfil = new cField('userlevels', 'userlevels', 'x_idperfil', 'idperfil', '"idperfil"', 'CAST("idperfil" AS varchar(255))', 3, -1, FALSE, '"idperfil"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "\"registro_derecho\".\"userlevels\"";
	}
